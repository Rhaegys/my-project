 ...
 */
final class Version20190710130757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE instrument (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, symbol VARCHAR(255) NOT NULL, quantity INT NOT NULL, INDEX IDX_3CBF69DD7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
